...
A four-choice country silhouette quiz that runs entirely in a web browser. It requires no server-side code, build process, or external CDN.
...
- Quick quiz: 10 randomized questions without repeated answers
- Full set: all 195 standard entries or all 205 expanded entries, each shown once
- Region mode: quick or full-set quizzes for any of six regions
...
- Higher-detail coastlines for Iceland and 111 other entries, including 35 large countries
...
- `SILHOUETTE_VALIDATION.md`: Regenerated silhouettes and quality checks
